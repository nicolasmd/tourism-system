...
&lt;!DOCTYPE fo:root [
        ...
        <xsl:choose>
          <xsl:when test="$page-size='ltr'">
            <fo:simple-page-master master-name="first" page-height="11in" page-width="8.5in" margin-right="72pt" margin-left="72pt" margin-bottom="36pt" margin-top="72pt">
              ...
              <fo:region-before region-name="rb-left" extent="0pt"/>
    ...
    =============================================== -->
          ...
          <xsl:otherwise>
            <fo:simple-page-master master-name="first" page-height="29.7cm" page-width="21cm" margin-right="72pt" margin-left="72pt" margin-bottom="36pt" margin-top="72pt">
              ...
              <fo:region-before region-name="rb-left" extent="0cm"/>
                ...
                <fo:table-row>
                  <fo:table-cell>
                    <fo:block text-align="start">Page 
                      <fo:page-number/> 
                      of <fo:page-number-citation ref-id="TheVeryLastPage"/>
                    </fo:block>
                  </fo:table-cell>
                  <fo:table-cell>
                    <fo:block text-align="end">
  ...
  <xsl:template match="blockquote">
    <fo:block start-indent="1.5cm" end-indent="1.5cm" space-after="12pt">
      <xsl:apply-templates select="*|text()"/>
    </fo:block>
  </xsl:template>
  ...
  <!-- ============================================
    ...
    <fo:flow flow-name="xsl-region-body">
      ...
      <fo:block space-after="12pt" line-height="17pt" font-size="14pt" text-align="center">
        
      </fo:block>
      <fo:block space-after="24pt" line-height="17pt" font-size="14pt" text-align="center" font-weight="bold" font-family="monospace">
  ...
  <xsl:template match="h1">
    ...
    <fo:block font-size="28pt" line-height="32pt" keep-with-next="always" space-after="22pt" font-family="serif">
      <xsl:attribute name="id">
        <xsl:choose>
          <xsl:when test="@id">
            <xsl:value-of select="@id"/>
          </xsl:when>
          <xsl:when test="name(preceding-sibling::*[1]) = 'a' and                           preceding-sibling::*[1][@name]">
  ...
  <xsl:template match="h2">
    <fo:block font-size="20pt" line-height="28pt" keep-with-next="always" margin-top="20pt" font-family="Helvetica">
      <xsl:attribute name="id">
        <xsl:choose>
          <xsl:when test="@id">
            <xsl:value-of select="@id"/>
  ...
  <xsl:template match="h3">
    <fo:block font-size="21pt" line-height="24pt" keep-with-next="always" space-after="14pt" font-family="serif">
      <xsl:attribute name="id">
        <xsl:choose>
          <xsl:when test="@id">
            <xsl:value-of select="@id"/>
  ...
  <xsl:template match="h4">
    <fo:block font-size="18pt" line-height="21pt" keep-with-next="always" space-after="12pt" font-family="serif">
      <xsl:attribute name="id">
        <xsl:choose>
          <xsl:when test="@id">
            <xsl:value-of select="@id"/>
  ...
  <xsl:template match="h5">
    <fo:block font-size="16pt" line-height="19pt" keep-with-next="always" space-after="12pt" font-family="serif" text-decoration="underline">
      <xsl:attribute name="id">
        <xsl:choose>
          <xsl:when test="@id">
            <xsl:value-of select="@id"/>
  ...
  <xsl:template match="h6">
    <fo:block font-size="14pt" line-height="17pt" keep-with-next="always" space-after="12pt" font-family="serif" font-style="italic" text-decoration="underline">
      <xsl:attribute name="id">
        <xsl:choose>
          <xsl:when test="@id">
            <xsl:value-of select="@id"/>
  ...
  <xsl:template match="table">
    <fo:table table-layout="fixed">
      <!--xsl:choose>
        ...
        <fo:table-body>
		  <!-- Parcourir les tr pour faire des table-row -->
			<!-- Parcourir les td pour faire des table-cell -->
		<xsl:for-each select="./tr">
			<fo:table-row>
				<xsl:if test="@height">
					<xsl:copy-of select="@height" />
				</xsl:if>
				<xsl:for-each select="./*[name()='td' or name()='th']">
					<fo:table-cell>
					  <xsl:if test="@colspan">
					  ...
					  <xsl:if test="@border='1' or                      ancestor::tr[@border='1'] or                     ancestor::thead[@border='1'] or                     ancestor::table[@border='1']">
  ...
  <!--xsl:template match="th">
    <fo:table-cell padding-start="3pt" padding-end="3pt" padding-before="3pt" padding-after="3pt">
      <xsl:if test="@border='1' or                      ancestor::tr[@border='1'] or                     ancestor::table[@border='1']">
        <xsl:attribute name="border-style">
          <xsl:text>solid</xsl:text>
        </xsl:attribute>
        <xsl:attribute name="border-color">
  ...
  <xsl:template match="title">
    <fo:block space-after="18pt" line-height="27pt" font-size="24pt" font-weight="bold" text-align="center">
      <xsl:apply-templates select="*|text()"/>
    </fo:block>
  </xsl:template>
  ...
  <xsl:template match="fieldset">
	...
	<fo:block border-style="solid" border-width="1pt">
		<fo:block margin="2pt">
			<fo:table table-layout="fixed">
				<fo:table-body>
					<fo:table-row>
  ...
  <xsl:template name="toc">
    ...
    <xsl:for-each select="/html/body//h1 |                           /html/body//h2 |                            /html/body//h3 |                           /html/body//h4">
