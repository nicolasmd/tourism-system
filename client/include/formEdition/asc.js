...
Ext.ts.ASC = [{
	...
	items: [{
		fieldset: 'Activités culturelles',
		items: [{
			xtype: 'listmth',
			id: 'asc_activites_culturelles',
			tsName: 'asc_activites_culturelles',
			LS: 'LS_ControlledVocabulary',
			key: '02.01.01.01.*'
		}]
	},{
		fieldset: 'Activités sportives',
		items: [{
			xtype: 'listmth',
			id: 'asc_activites_sportives',
			tsName: 'asc_activites_sportives',
			LS: 'LS_ControlledVocabulary',
			key: '02.01.01.02.*'
		}]
	},{
		fieldset: "Catégorie d'activités sportives",
		items: [{
			xtype: 'listmth',
			id: 'asc_categorie_activites_sportives',
			tsName: 'asc_categorie_activites_sportives',
			LS: 'LS_ControlledVocabulary',
			key: '02.01.01.03.*'
		}]
	},{
		fieldset: 'Formules itinérantes',
		items: [{
			xtype: 'listmth',
			id: 'asc_formules_itinerantes',
			tsName: 'asc_formules_itinerantes',
			LS: 'LS_ControlledVocabulary',
			key: '02.01.01.04.*'
		}]
	}]
