...
Ext.ts.PCU = [{
	...
	items: [{
		fieldset: 'Catégories de musées',
		items: [{
			xtype: 'listmth',
			id: 'pcu_categories_musees',
			tsName: 'pcu_categories_musees',
			LS: 'LS_ControlledVocabulary',
			key: '02.01.11.01.*',
			groupColumns: 5
		}]
	},{
		fieldset: 'Catégories des parcs et jardins',
		items: [{
			xtype: 'listmth',
			id: 'pcu_categories_parcs_jardins',
			tsName: 'pcu_categories_parcs_jardins',
			LS: 'LS_ControlledVocabulary',
			key: '02.01.11.02.*',
			groupColumns: 5
		}]
	},{
		fieldset: 'Catégories des sites et monuments historiques',
		items: [{
			xtype: 'listmth',
			id: 'pcu_categories_sites_monuments',
			tsName: 'pcu_categories_sites_monuments',
			LS: 'LS_ControlledVocabulary',
			key: '02.01.11.03.*',
			groupColumns: 5
		}]
	},{
		fieldset: 'Equipements principaux',
		items: [{
			xtype: 'listmth',
			id: 'pcu_equipements',
			tsName: 'pcu_equipements',
			LS: 'LS_ControlledVocabulary',
			key: '02.01.11.04.*',
			groupColumns: 5
		}]
	},{
		fieldset: 'Styles architecturaux des parcs et jardins',
		items: [{
			xtype: 'listmth',
			id: 'pcu_styles_parcs_jardins',
			tsName: 'pcu_styles_parcs_jardins',
			LS: 'LS_ControlledVocabulary',
			key: '02.01.11.05.*',
			groupColumns: 5
		}]
	},{
		fieldset: 'Styles architecturaux des sites et monuments historiques',
		items: [{
			xtype: 'listmth',
			id: 'pcu_styles_sites_monuments',
			tsName: 'pcu_styles_sites_monuments',
			LS: 'LS_ControlledVocabulary',
			key: '02.01.11.06.*',
			groupColumns: 5
		}]
	},{
		fieldset: 'Thèmes des musées',
		items: [{
			xtype: 'listmth',
			id: 'pcu_themes_musees',
			tsName: 'pcu_themes_musees',
			LS: 'LS_ControlledVocabulary',
			key: '02.01.11.07.*',
			groupColumns: 5
		}]
	},{
		fieldset: 'Thèmes des parcs et jardins',
		items: [{
			xtype: 'listmth',
			id: 'pcu_themes_parcs_jardins',
			tsName: 'pcu_themes_parcs_jardins',
			LS: 'LS_ControlledVocabulary',
			key: '02.01.11.08.*',
			groupColumns: 5
		}]
	},{
		fieldset: 'Thèmes des sites et monuments historiques',
		items: [{
			xtype: 'listmth',
			id: 'pcu_themes_sites_monuments',
			tsName: 'pcu_themes_sites_monuments',
			LS: 'LS_ControlledVocabulary',
			key: '02.01.11.09.*',
			groupColumns: 5
		}]
	},{
		fieldset: "Types des centres d'interprétation",
		items: [{
			xtype: 'listmth',
			id: 'pcu_types_centres_interpretation',
			tsName: 'pcu_types_centres_interpretation',
			LS: 'LS_ControlledVocabulary',
			key: '02.01.11.10.*',
			groupColumns: 5
		}]
